        ...
        <div class="row">
            <div class="col-md-6 m-auto bg-white shadow font-monospace border boder-info my-5">
                ...
                <form action="insert.php" method="post">
                    ...
                    <div class='mb-3'>
                        <button class='w-100 bg-warning fs-4 text-white' name='submit'>Register</button>
                    </div>
                    <div class='mb-3'>
                        <button class='w-100 bg-danger fs-4 text-white'><a href="login.php" class='text-decoration-none text-white'>Alredy Account</a></button>
                    </div>
                </form>
            </div>
        </div>
